...
public class ActiveRoseClusterBlock extends Block {
    private final Block block;
    public static final IntProperty AGE = Properties.AGE_2;
    public static final int AGE_CHANCE = 15;
    public static final int GROWTH_CHANCE = 20;
    public static final int CLUSTER_GROWTH_CHANCE = 25;
    ...
    public ActiveRoseClusterBlock(Block block, Settings settings) {
        super(settings);
        this.block = block;
